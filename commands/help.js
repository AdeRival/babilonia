...
module.exports.run = async (bot, message, args) => {
    ...
    if(!args[0]) {
        ...
        .setThumbnail(bot.user.displayAvatarURL)
        .setTimestamp()
        .setDescription(`**BOT Prefix**: \`${prefix}\`\n**⬇️Perintah Yang Tersedia Pada Rival Development BOT⬇️**`)
