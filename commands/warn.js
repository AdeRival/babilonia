...
exports.run = (bot, message, args) => {
    ...
    if (!user) {
        return message.reply('You must mention someone to warn him. **Usage:**`r!warn [@mention] [example]`');
    }
    if (!reason) {
        return message.reply('You must give me a reason for warning **Usage:**`r!warn [@mention] [example]`');
    }
